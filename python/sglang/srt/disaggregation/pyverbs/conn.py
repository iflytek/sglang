...
class PyverbsKVManager(BaseKVManager):
    ...
    def __init__(
        ...
        self.aux_data_ptrs = args.aux_data_ptrs  # Pointers to auxiliary data memory regions
        self.aux_data_lens = args.aux_data_lens  # Lengths of auxiliary data memory regions
