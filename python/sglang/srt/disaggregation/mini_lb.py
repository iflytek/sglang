...
class MiniLoadBalancer:
    ...
    async def chat_completion_request(self, request_data):
...
async def handle_chat_completions(request_data: dict):
    ...
    # Non-streaming case
    result = await load_balancer.chat_completion_request(request_data)
